...
cap = cv2.VideoCapture('Speed-detection-of-vehicles\\highway.mp4')
...
while True:
    ...
    for bbox in bbox_id:
        ...
        #         cv2.putText(frame, str(id), (cx, cy), cv2.FONT_HERSHEY_DUPLEX, 0.8, (0, 255, 255), 2)
    ...
    cv2.rectangle(frame, (347,2), (471,28), yellow_color, -1)
    cv2.rectangle(frame, (517,2), (641,28), yellow_color, -1)
    ...
    cv2.putText(frame, ('⬇: ' + str(len(counter_down))), (350, 20) , cv2.FONT_HERSHEY_DUPLEX, 0.5, text_color, 1, cv2.LINE_AA)
    cv2.putText(frame, ('⬆: ' + str(len(counter_up))), (520, 20), cv2.FONT_HERSHEY_DUPLEX, 0.5, text_color, 1, cv2.LINE_AA)
